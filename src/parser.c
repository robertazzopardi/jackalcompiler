                                           ...
                                           (token.associate == left_to_right))))
                {
                         ...
                         (e2->data.attr == _int || e2->data.attr == _float)))
                    {
                        ...
                        push(&output_stack, evaluateExpression(op, e1, e2));
                             ...
                             op->data.attr == _funcCall && (e1->data.attr == _comma || e2->data.attr == _comma))
                    {
                    ...
                    else if (!operator_stack && op->data.attr == _funcCall && e1 && e1->data.attr == _funcCall)
                    {
                        push(&output_stack, newNodeLeft(op->data, e1));
                    }

                    else if (!operator_stack && op->data.attr == _funcCall && e2 && e2->data.attr == _funcCall)
                    {
                        push(&output_stack, newNodeLeft(op->data, e2));
                    }

                    else if (operator_stack->data->data.attr == _operator && operator_stack->next->data->data.attr != _funcCall)
                    {
                    ...
                    else if (operator_stack->data->data.attr == _funcCall && e1->data.attr == _comma && e2->data.attr != _comma)
                    {
                        Node *func = pop(&operator_stack);
                    ...
                    else if (op->data.attr == _funcCall && e2->data.attr == _funcCall)
                    {
                        push(&output_stack, newNodeLeft(op->data, e2));
                    }

                    else if (operator_stack->data->data.attr == _leftBracket && op->data.attr == _funcCall &&
                    ...
                    else if (op->data.attr == _funcCall && e1 && !e2)
                    {
                        op->leftNode = e1->leftNode;
                        op->rightNode = e1->rightNode;
                    ...
                    else if (op->data.attr == _funcCall && e1->data.attr == _comma && e2->data.attr == _comma)
                    {
                        Node *opop = pop(&operator_stack);
